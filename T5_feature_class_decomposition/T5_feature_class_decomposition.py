"""
Quantlet T5_feature_class_decomposition

Per-feature-class decomposition: entity-related (33) vs non-entity (453). XGBoost ratio 2.50x; CatBoost ratio 0.91x.

Datafile(s): T5_feature_class_decomposition.csv
Output:      T5_feature_class_decomposition.csv, T5_feature_class_decomposition.pdf, T5_feature_class_decomposition.png

Run from inside this folder:
    python T5_feature_class_decomposition.py
or open T5_feature_class_decomposition.ipynb in Jupyter.
"""
...
INPUT      = "T5_feature_class_decomposition.csv"
OUTPUT_CSV = "T5_feature_class_decomposition.csv"
OUTPUT_PDF = "T5_feature_class_decomposition.pdf"
OUTPUT_PNG = "T5_feature_class_decomposition.png"
