"""
Quantlet T2b_cross_config

T2b cross-pair test: control vs real-embedding hybrid -- residual stability channel beyond column augmentation.

Datafile(s): T2b_cross_config.csv
Output:      T2b_cross_config.csv, T2b_cross_config.pdf, T2b_cross_config.png

Run from inside this folder:
    python T2b_cross_config.py
or open T2b_cross_config.ipynb in Jupyter.
"""
...
INPUT      = "T2b_cross_config.csv"
OUTPUT_CSV = "T2b_cross_config.csv"
OUTPUT_PDF = "T2b_cross_config.pdf"
OUTPUT_PNG = "T2b_cross_config.png"
