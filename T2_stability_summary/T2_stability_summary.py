...
Output:      T2_stability_summary.csv, T2_stability_summary.tex

Run from inside this folder:
    python T2_stability_summary.py
or open T2_stability_summary.ipynb in Jupyter.
"""
...
OUTPUT_TEX = "T2_stability_summary.tex"
