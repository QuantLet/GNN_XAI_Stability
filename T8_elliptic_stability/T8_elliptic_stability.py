"""
Quantlet T8_elliptic_stability

Elliptic Bitcoin replication: headline xgb_tab vs xgb_sage_l1 (46.1% flagged, delta_k=-0.0299) and T2b cross-pair (39.4%, delta_k=-0.0243).

Datafile(s): T8_elliptic_stability.csv
Output:      T8_elliptic_stability.csv, T8_elliptic_stability.pdf, T8_elliptic_stability.png

Run from inside this folder:
    python T8_elliptic_stability.py
or open T8_elliptic_stability.ipynb in Jupyter.
"""
...
INPUT      = "T8_elliptic_stability.csv"
OUTPUT_CSV = "T8_elliptic_stability.csv"
OUTPUT_PDF = "T8_elliptic_stability.pdf"
OUTPUT_PNG = "T8_elliptic_stability.png"
